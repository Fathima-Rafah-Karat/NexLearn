                    ...
                    <div className="flex-1 px-6 scrollbar-hide">
                        ...
                        <div className="bg-white border border-[#E2E8F0] shadow-[0px_0px_12px_4px_#00000017] rounded-xl p-6 md:p-8 mb-3">
                            <Dialog>
                                ...
                                <DialogContent showCloseButton={false} className="w-[calc(100vw-2rem)] sm:w-[90vw] md:w-[1000px] max-w-[1000px] sm:max-w-[1000px] max-h-[600px] bg-white border-[#E2E8F0] p-4 sm:p-6 md:p-10 rounded-[10px] gap-0 overflow-hidden flex flex-col">
